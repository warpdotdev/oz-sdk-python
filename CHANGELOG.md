...
* [Artifacts] public API file artifact downloads ([d215ac1](https://github.com/warpdotdev/oz-sdk-python/commit/d215ac188d337d3e843a0889f0ec40ce52e7954e))
* Add harness enum to openAPI spec ([acbcf4d](https://github.com/warpdotdev/oz-sdk-python/commit/acbcf4d6c7c3f575ea9d6411ece8325d82377ea3))
* Add parent_run_id to retrieve/list runs API response ([fca4568](https://github.com/warpdotdev/oz-sdk-python/commit/fca4568ac9d099d86dc2238a452872846e20b39a))
* Add VMIdleTimeoutMinutes param to API ([0bcea48](https://github.com/warpdotdev/oz-sdk-python/commit/0bcea48400246eb8c84ad5e20685f734b7a77b10))
* Address Stainless diagnostics ([391cbe2](https://github.com/warpdotdev/oz-sdk-python/commit/391cbe2edbc77667ce837ad99626d3b050d984b5))
...
* **api:** add addnl filters to runs endpoint ([05024f6](https://github.com/warpdotdev/oz-sdk-python/commit/05024f6d7ac1e68cf63c4d4d1e4abf5712ebdfd5))
* **api:** add artifacts, worker_host, and new source types ([c1428e0](https://github.com/warpdotdev/oz-sdk-python/commit/c1428e0fb14a3e6c9d3b2e448bc441753d2a7e75))
* **api:** add computer_use_enabled param ([d871614](https://github.com/warpdotdev/oz-sdk-python/commit/d87161491b06481aa202220d2dd4fe3f8c8503a7))
* **api:** add models for agent skill, user profile ([caf88cf](https://github.com/warpdotdev/oz-sdk-python/commit/caf88cf231f3285b40bfe0d761c90b64794ede0a))
...
* **api:** add schedules to runs ([0c50dd3](https://github.com/warpdotdev/oz-sdk-python/commit/0c50dd3dd4e3858e49705b99fe07b94d21f69200))
* **api:** add schedules, agent list, skill-spec ([fb065cf](https://github.com/warpdotdev/oz-sdk-python/commit/fb065cf744a856dead59867829236837427b81c0))
* **api:** api update ([65f9613](https://github.com/warpdotdev/oz-sdk-python/commit/65f96139f10c0a99ce80d4335a781a8954389252))
* **api:** api update ([2459506](https://github.com/warpdotdev/oz-sdk-python/commit/2459506a360e0c3a357b63c22df305bba412ef97))
* **api:** api update ([8d67c5f](https://github.com/warpdotdev/oz-sdk-python/commit/8d67c5f2abce4d393111a76ca646074307d037f5))
* **api:** api update ([d37ac45](https://github.com/warpdotdev/oz-sdk-python/commit/d37ac45853f610cdfd3587c4faf922a33a7caa2f))
* **api:** api update ([5221502](https://github.com/warpdotdev/oz-sdk-python/commit/52215023c755a23a3b59dccaea61258d18a29add))
* **api:** api update ([0138a61](https://github.com/warpdotdev/oz-sdk-python/commit/0138a61bed28bde9a02b8649e0b6ffe2e2f714ff))
* **api:** api update ([3714739](https://github.com/warpdotdev/oz-sdk-python/commit/3714739ee9981dff8107988e64e24c70c4f21b13))
* **api:** api update ([9450eac](https://github.com/warpdotdev/oz-sdk-python/commit/9450eac628acb4e4642c83e16e7e1968914fa1f8))
* **api:** api update ([132263d](https://github.com/warpdotdev/oz-sdk-python/commit/132263df0442c38c13095b97e4d70d01fddaf593))
* **api:** catch up openapi, rename tasks -&gt; runs ([39d90e5](https://github.com/warpdotdev/oz-sdk-python/commit/39d90e541695eb68aaae59f8b8dc078d19a3060c))
* **api:** created at filter in list view ([bfe4091](https://github.com/warpdotdev/oz-sdk-python/commit/bfe4091f5750ac1a08f3a1c7e0d3595d7df3651e))
* **api:** error and error_code as types ([3c6062f](https://github.com/warpdotdev/oz-sdk-python/commit/3c6062fcc0ed459e4ebc387c56a18d20fae6b9a1))
* **api:** fix array query parameter formatting ([c71d8c2](https://github.com/warpdotdev/oz-sdk-python/commit/c71d8c2b8968ad12932b3aaa24f586bee86a05e4))
* **api:** fix ScheduledAgentHistoryItem name ([e34e2b0](https://github.com/warpdotdev/oz-sdk-python/commit/e34e2b0e147b7108f5b09d2498fb3802e1c7ab32))
* **api:** fix schema version issues ([c2fc075](https://github.com/warpdotdev/oz-sdk-python/commit/c2fc075abe0099eba74449de314995ec43cba903))
* **api:** manual updates ([96aaf48](https://github.com/warpdotdev/oz-sdk-python/commit/96aaf48d7e03514b9c95fb2183d81ce95d0a935d))
* **api:** manual updates ([f008bc3](https://github.com/warpdotdev/oz-sdk-python/commit/f008bc3200a013ab3fa0eb5e3e34fa525d285644))
* **api:** manual updates ([8bfda3e](https://github.com/warpdotdev/oz-sdk-python/commit/8bfda3e7cd0a2e85d50d949ef7f93880d1a7fe5a))
* **api:** manual updates ([8e21bd6](https://github.com/warpdotdev/oz-sdk-python/commit/8e21bd6fef3f974069a41df74133eb5d2d154b56))
* **api:** manual updates ([85f956c](https://github.com/warpdotdev/oz-sdk-python/commit/85f956cc6ebbfa120281e4cfe1f69b3bc0399f89))
* **api:** manual updates ([c13884d](https://github.com/warpdotdev/oz-sdk-python/commit/c13884d6d32892e394dfa2de846361eed8182c47))
* **api:** manual updates ([010459f](https://github.com/warpdotdev/oz-sdk-python/commit/010459f4416b30f467c92a1ffd3bb770713b1410))
* **api:** manual updates ([8aafbea](https://github.com/warpdotdev/oz-sdk-python/commit/8aafbeae40cd6884897fc180bd06881ae21b4441))
* **api:** manual updates ([2fc23de](https://github.com/warpdotdev/oz-sdk-python/commit/2fc23de0e1d42443e691350804605243c5902026))
* **api:** manual updates ([4d4a408](https://github.com/warpdotdev/oz-sdk-python/commit/4d4a4082d453daeb3d388ac1a23cf951ada27a9e))
* **api:** manual updates ([cd0ec74](https://github.com/warpdotdev/oz-sdk-python/commit/cd0ec747479cbb56159a361853787871c1c61395))
...
* **api:** new run source types ([69ac0d5](https://github.com/warpdotdev/oz-sdk-python/commit/69ac0d556368ad284f55361ca94048d3fe7aabc9))
* **api:** sorting ([4499e74](https://github.com/warpdotdev/oz-sdk-python/commit/4499e745a3bed3354e833de27fc0961b40e25bbf))
* **api:** update artifacts ([fd350f5](https://github.com/warpdotdev/oz-sdk-python/commit/fd350f5e66d61054495423c6b6b2ed75d9ec302e))
* **client:** add custom JSON encoder for extended type support ([e3304b4](https://github.com/warpdotdev/oz-sdk-python/commit/e3304b4eaa4d4e7d64c193c9fc819ead99175ff1))
* **client:** add support for binary request streaming ([ec13139](https://github.com/warpdotdev/oz-sdk-python/commit/ec131390a4a120add02ae130c0437e87649cba3d))
...
* Create run for every local conversation and add filter ([f5fe718](https://github.com/warpdotdev/oz-sdk-python/commit/f5fe71808360759f113acdcbd4e0d1444b18832e))
* Define auth secrets and inject them into the environment. ([3706e8d](https://github.com/warpdotdev/oz-sdk-python/commit/3706e8d0eaf20ea9f8a15213d9908fbf7c864a2b))
...
* Endpoint to upload third-party harness block snapshots ([90186b0](https://github.com/warpdotdev/oz-sdk-python/commit/90186b0fdee743df48bd57024011e0bc4f6c09b1))
* Fix the harness type in the openAPI spec ([16d2787](https://github.com/warpdotdev/oz-sdk-python/commit/16d2787c014e4023269991cf63618d970fb1422a))
* ian/fix_conversation_id_nameing ([75510e0](https://github.com/warpdotdev/oz-sdk-python/commit/75510e04dddfb826c4b61bcc7ad1ae9b006a4abb))
* **internal:** implement indices array format for query and form serialization ([8b16e67](https://github.com/warpdotdev/oz-sdk-python/commit/8b16e67854a20bdb600f7d6093bbe472ed1e18cf))
* Orchestrations V2: Public API endpoints ([d24dbdf](https://github.com/warpdotdev/oz-sdk-python/commit/d24dbdf2ee0e4d1888c8bfae533534659670afc9))
...
* Use correct branch for Stainless PRs ([ef6b97b](https://github.com/warpdotdev/oz-sdk-python/commit/ef6b97b9f8c2fcb2ed7395174ae16f1154288009))


### Bug Fixes

* **client:** preserve hardcoded query params when merging with user params ([3446e91](https://github.com/warpdotdev/oz-sdk-python/commit/3446e91eda938945ec28314a1870e5aca55b74ec))
* **deps:** bump minimum typing-extensions version ([cea2f69](https://github.com/warpdotdev/oz-sdk-python/commit/cea2f69fe6b0450bd3c981e88205aa6355dd723d))
* **deps:** drop Python 3.9, pin .python-version to 3.10.16 ([fd4a67a](https://github.com/warpdotdev/oz-sdk-python/commit/fd4a67ac8fd8daf9c37a055fe4623e9f3be46137))
...
* **pydantic:** do not pass `by_alias` unless set ([94799da](https://github.com/warpdotdev/oz-sdk-python/commit/94799da62dc2f0be030c3cc1f54e9f148a5b2a74))
* sanitize endpoint path params ([f3430e3](https://github.com/warpdotdev/oz-sdk-python/commit/f3430e39267980580344db78c194ca9a4c2b2c51))
...
* use async_to_httpx_files in patch method ([c02afdb](https://github.com/warpdotdev/oz-sdk-python/commit/c02afdbec958df84a3e1ec73e213e683c79b04e8))


### Chores

* **ci:** bump uv version ([f22f581](https://github.com/warpdotdev/oz-sdk-python/commit/f22f5816fe115d8d7ca4e0da7e09d650d736c8e4))
* **ci:** skip lint on metadata-only changes ([3814a0d](https://github.com/warpdotdev/oz-sdk-python/commit/3814a0d5d6e9c92a3cd9fb846a5f2381e5eb483c))
* **ci:** skip uploading artifacts on stainless-internal branches ([4dc211d](https://github.com/warpdotdev/oz-sdk-python/commit/4dc211d0f52b0f00186a8e4797819d088ccd29ab))
* **ci:** upgrade `actions/github-script` ([cc2ac65](https://github.com/warpdotdev/oz-sdk-python/commit/cc2ac65f42d183948fdbba39da37a506334c31ca))
* **docs:** add missing descriptions ([2cc2d99](https://github.com/warpdotdev/oz-sdk-python/commit/2cc2d99a9b37f0b1509ae49a8019de5fb3b4cec5))
* format all `api.md` files ([7fdbd37](https://github.com/warpdotdev/oz-sdk-python/commit/7fdbd374b64e4ca75460e3ea561f18b0cc0b7251))
* **internal:** add `--fix` argument to lint script ([46a9b4b](https://github.com/warpdotdev/oz-sdk-python/commit/46a9b4bdceac62a8939f66b0227943d18db5393f))
* **internal:** add missing files argument to base client ([041d054](https://github.com/warpdotdev/oz-sdk-python/commit/041d0540f460ed7ecee3ed66a8db6ea9ae607360))
* **internal:** add request options to SSE classes ([63f457a](https://github.com/warpdotdev/oz-sdk-python/commit/63f457a8bbb44f8424f832435d2bff635e741f1d))
* **internal:** bump dependencies ([4042859](https://github.com/warpdotdev/oz-sdk-python/commit/4042859b4a3ae811bb9e3b6daed907b82e1d8c7d))
* **internal:** fix lint error on Python 3.14 ([07fd1df](https://github.com/warpdotdev/oz-sdk-python/commit/07fd1df58c0dfb50ce1a353ce037a3e2934d4ee7))
* **internal:** make `test_proxy_environment_variables` more resilient ([6159f07](https://github.com/warpdotdev/oz-sdk-python/commit/6159f0733d6c7a080cde5a8d6224b78721628abe))
* **internal:** make `test_proxy_environment_variables` more resilient to env ([de673c8](https://github.com/warpdotdev/oz-sdk-python/commit/de673c86956e4fdc75eab16f69a8bb845be25894))
* **internal:** remove mock server code ([bbe2b1d](https://github.com/warpdotdev/oz-sdk-python/commit/bbe2b1d129c2c64f038e6bd7b2830b751aaf6b8e))
* **internal:** tweak CI branches ([49c27b8](https://github.com/warpdotdev/oz-sdk-python/commit/49c27b8d903623195dfb893a09542c485cdf1c73))
* **internal:** update `actions/checkout` version ([14b1816](https://github.com/warpdotdev/oz-sdk-python/commit/14b1816ef0ffca2a1998064e329a10d20cf6bfbb))
* **internal:** update gitignore ([de3d781](https://github.com/warpdotdev/oz-sdk-python/commit/de3d7819bce97ec02044da061db249c987a87047))
...
* speedup initial import ([c6fa047](https://github.com/warpdotdev/oz-sdk-python/commit/c6fa04747ba3b056f9dff28e564e25b4e257ca5e))
...
* update mock server docs ([9a0e0ad](https://github.com/warpdotdev/oz-sdk-python/commit/9a0e0ad2a85682a672326bb15acb09a36ded450d))
...
* update SDK settings ([119d498](https://github.com/warpdotdev/oz-sdk-python/commit/119d4987b018f42c33e38923d6f96597e210dafd))
* update SDK settings ([aa219d3](https://github.com/warpdotdev/oz-sdk-python/commit/aa219d38164174a31ec1812eb142af727db8b40b))
* update SDK settings ([550bf88](https://github.com/warpdotdev/oz-sdk-python/commit/550bf8880e74e209234ea839f4d283cc94a16fa4))
* update SDK settings ([6712331](https://github.com/warpdotdev/oz-sdk-python/commit/671233139a77c3fd3744609b82b967802f1a33b7))
* update SDK settings ([681e2ef](https://github.com/warpdotdev/oz-sdk-python/commit/681e2ef8f6c0f084ac01bc299715481ad764032b))
* update SDK settings ([4d89e8a](https://github.com/warpdotdev/oz-sdk-python/commit/4d89e8abaed7fea69d87db0f7246b5642fbdb071))
...
* update SDK settings ([a94be20](https://github.com/warpdotdev/oz-sdk-python/commit/a94be20a45967c6ec5bd95dcc3ffcf457db84305))
* update SDK settings ([217b866](https://github.com/warpdotdev/oz-sdk-python/commit/217b866ef03a583415f0fcdd65385ee76d53c664))
* update SDK settings ([cc95759](https://github.com/warpdotdev/oz-sdk-python/commit/cc9575998cf34b016f70f8209043a02ad1677399))


### Documentation

* add environment and config usage documentation ([ef5d0c3](https://github.com/warpdotdev/oz-sdk-python/commit/ef5d0c342ce46c88c374c9bb3b4c63e36f22ec6b))
* add environment and config usage documentation ([487b1cf](https://github.com/warpdotdev/oz-sdk-python/commit/487b1cfac5fcd89d4c91f88903ef8b601da8269d))
* **dev:** Add WARP.md file ([982836f](https://github.com/warpdotdev/oz-sdk-python/commit/982836f53b31bed664e9b85cc59883021e451bb3))


### Refactors

* **internal:** switch from rye to uv ([d4cdfd0](https://github.com/warpdotdev/oz-sdk-python/commit/d4cdfd0384b63f1ce244cdbb4327043cff02f682))
